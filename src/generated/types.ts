...
export type AgreedService = {
  ...
  isBillingCompleted?: Maybe<Scalars['Boolean']['output']>;
  ...
  price: ProposalFixedPrice | ProposalIncludedPrice | ProposalMinimumPrice | ProposalPriceRange | ProposalUnitPrice;
  /** Quantity Object containing amounts and rules */
  quantity?: Maybe<BillingEstimateQuantityRule | BillingSmartBillingQuantityRule>;
...
export type ApiAccessTokenRevokeInput = {
...
export type ApiAccessTokenRevokePayload = {
  __typename: 'ApiAccessTokenRevokePayload';
...
export type BankAccountFailureEmailTemplate = EmailTemplateInterface & PracticeTemplate & {
...
export type BankAccountVerificationEmailTemplate = EmailTemplateInterface & PracticeTemplate & {
...
export type BillableService = {
  ...
  billingItems?: Maybe<BillingItemConnection>;
  description: Textile;
  id: Scalars['ID']['output'];
  invoiceStrategy?: Maybe<ProposalInvoiceStrategy>;
  name: Scalars['String']['output'];
...
export type BillingItem = {
  ...
  price?: Maybe<Money>;
  priceRule: ProposalFixedPrice | ProposalIncludedPrice | ProposalMinimumPrice | ProposalPriceRange | ProposalUnitPrice;
...
export type BillingSchedule = {
  ...
  billingDescription?: Maybe<Scalars['String']['output']>;
  billingSummary?: Maybe<Scalars['String']['output']>;
  dates?: Maybe<Array<Scalars['Date']['output']>>;
...
export type Client = {
  ...
  /** agreed services */
  agreedServices?: Maybe<AgreedServiceConnection>;
  appClients: AppClientConnection;
  automaticBillingGroup?: Maybe<BillingItemGroup>;
  automaticBillingGroups?: Maybe<BillingItemGroupConnection>;
  billableServices?: Maybe<BillableServiceConnection>;
  ...
  willDeployInvoices?: Maybe<Scalars['Boolean']['output']>;
  workflowItem?: Maybe<ClientWorkflowItem>;
  workflowStrategies?: Maybe<ClientWorkflowStrategyConnection>;
  /**
...
export type ClientBillingBillingGroupSource = Client | Engagement | Project | Proposal;
...
export type ClientBillingInvoice = {
  ...
  deployments?: Maybe<ClientBillingInvoiceDeploymentConnection>;
...
export type ClientBillingInvoiceIssuePayload = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  invoices?: Maybe<Array<ClientBillingInvoice>>;
};
...
export type ClientWorkflowItem = {
  ...
  appName: Scalars['String']['output'];
  budget?: Maybe<Money>;
  categories?: Maybe<Array<WorkflowCategoryType>>;
  createdAt: Scalars['DateTime']['output'];
  ...
  templates?: Maybe<Array<WorkflowTemplateType>>;
  updatedAt: Scalars['DateTime']['output'];
};
...
export type CustomerSuccessMaturityIndexUnion = CustomerSuccessMaturityIndex | CustomerSuccessVersion1MaturityIndex;
...
export type DashboardSettings = {
  ...
  budgets?: Maybe<Array<DashboardBudget>>;
...
export type Disbursal = {
  ...
  disputes?: Maybe<PaymentsDisbursalDisputeConnection>;
...
export type Engagement = {
  ...
  acceptedPaymentMethodTypes?: Maybe<Array<PaymentMethodType>>;
  ...
  paymentMethod?: Maybe<PaymentMethod>;
  referenceNumber: Scalars['ID']['output'];
  /** @deprecated Use id instead, which, for a time, will be uuid value (also deprecated), but then will be slug value. */
  uuid: Scalars['ID']['output'];
};
...
export type Ipm = {
  ...
  services?: Maybe<Array<IpmService>>;
  status: IpmStatus;
  workTemplateMappings?: Maybe<Array<IpmWorkTemplateMapping>>;
  workTemplates?: Maybe<Array<IpmWorkTemplate>>;
};
...
export type Karbon = {
  __typename: 'Karbon';
  apiKey?: Maybe<Scalars['String']['output']>;
  services?: Maybe<Array<KarbonService>>;
  status: KarbonStatus;
  workTemplateMappings?: Maybe<Array<KarbonWorkTemplateMapping>>;
  workTemplates?: Maybe<Array<KarbonWorkTemplate>>;
};
...
export type Mutation = {
  ...
  apiAccessTokenRevoke?: Maybe<ApiAccessTokenRevokePayload>;
...
export type MutationApiAccessTokenRevokeArgs = {
...
export type NewGroupProposalEmailTemplate = EmailTemplateInterface & PracticeTemplate & {
...
export type NewProposalEmailTemplate = EmailTemplateInterface & PracticeTemplate & {
...
export type NewSubmissionEmailTemplate = EmailTemplateInterface & PracticeTemplate & {
...
export type Notifications = {
   ...
   */
  announcementToSecondarySignatoryEmail: NotificationSample;
  /** Sample of email sent to secondary signatories announcing that they will soon be asked for their signature */
   ...
   */
  awaitingSignatureToSignatoryEmail: NotificationSample;
  /** Sample of email sent to signatories when their signature is needed */
  awaitingSignatureToSignatoryEmailPreview: EmailPreview;
};

/** The connection type for Notification. */
export type NotificationsConnectionType = {
  __typename: 'NotificationsConnectionType';
  /** A list of edges. */
...
export type PaymentGateway = {
  ...
  paymentMethodTypes?: Maybe<Array<PaymentMethodType>>;
...
export type Plan = {
  ...
  directDebitPriceText?: Maybe<Scalars['String']['output']>;
  /** An HTML snippet about what credit card processing is */
  domesticCreditCard?: Maybe<Scalars['Html']['output']>;
  /**
  ...
  implementation?: Maybe<Scalars['Html']['output']>;
  includesTax: Scalars['Boolean']['output'];
  /** An HTML snippet about what International amex processing is */
  internationalAmexCard?: Maybe<Scalars['Html']['output']>;
  ...
  numberOfProposals?: Maybe<Scalars['Int']['output']>;
  /** A snipped about the additional fees associated to a credit card */
  paymentsCreditCardChargeText?: Maybe<Scalars['String']['output']>;
  /** A snippet about the additional fees for amex processing */
  paymentsInternationalAmexCardChargeText?: Maybe<Scalars['String']['output']>;
  /**
...
export enum PlanFeature {
  ...
  BEST_PRACTICE_COACH = 'BEST_PRACTICE_COACH',
  BUSINESS_INTELLIGENCE_DASHBOARD = 'BUSINESS_INTELLIGENCE_DASHBOARD',
  ONBOARDING = 'ONBOARDING',
  SECURE_STORAGE = 'SECURE_STORAGE',
  SERVICE_LIBRARY_WITH_MARKET_PRICE = 'SERVICE_LIBRARY_WITH_MARKET_PRICE',
...
export type Portion = {
  __typename: 'Portion';
  billingSchedule: ProposalOnceOffBillingSchedule | ProposalRecurringBillingSchedule;
  description?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  invoiceStrategy: ProposalInvoiceStrategy;
...
export type Practice = {
  __typename: 'Practice';
  /** @deprecated Use root level accounts instead */
  accounts?: Maybe<AccountConnection>;
  billing: PracticeBilling;
  /** Currency used for billing clients */
  billingCurrency: Currency;
  /** @deprecated Access through Xero instead */
  brandingThemes?: Maybe<XeroBrandingThemeConnection>;
  clientDefaultEmailSettings: Array<EmailSettings>;
  /** @deprecated Use root level clients instead */
  ...
  /** @deprecated Use brandingTheme.colour instead */
  ...
  /**
   * Currency used for billing clients
   * @deprecated Use billingCurrency instead.
   */
  currency: Currency;
  ...
  /** @deprecated Use root level paymentGateways instead */
  paymentGateways?: Maybe<PaymentGatewayConnectionType>;
  paymentRegion?: Maybe<Scalars['String']['output']>;
  paymentSettings: PaymentSettings;
  /** @deprecated Use root level payments instead */
  payments?: Maybe<Payments>;
  plan?: Maybe<Plan>;
  /** @deprecated Use root level templates instead */
  ...
  /** @deprecated Use root level taxes instead */
...
export type PracticeAccountsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type PracticeBrandingThemesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type PracticePaymentGatewaysArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type PracticePracticeTemplatesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type PracticeBilling = {
  ...
  availablePlans?: Maybe<Array<PracticeBillingPlan>>;
  ...
  invoices?: Maybe<PracticeBillingInvoiceConnection>;
  paymentChallenge?: Maybe<PracticeBillingPaymentChallenge>;
  paymentMethods?: Maybe<Array<PracticeBillingPaymentMethod>>;
...
export type PracticeBillingInvoice = {
  ...
  id: Scalars['ID']['output'];
  items?: Maybe<Array<PracticeBillingInvoiceItem>>;
...
export type PracticeBillingPlan = {
  ...
  /** Name of plan that is used for display */
  name: Scalars['String']['output'];
  products: Array<PracticeBillingClientProduct | PracticeBillingOtherProduct | PracticeBillingPaymentFeeProduct | PracticeBillingPlanProduct>;
  /** Plan tier that practice is on */
...
export type PracticeBillingSubscription = {
  ...
  coupons?: Maybe<Array<PracticeBillingCoupon>>;
  endDate?: Maybe<Scalars['Date']['output']>;
  frequency?: Maybe<PracticeBillingPlanFrequency>;
  ...
  products?: Maybe<Array<PracticeBillingClientProduct | PracticeBillingOtherProduct | PracticeBillingPaymentFeeProduct | PracticeBillingPlanProduct>>;
...
export type PracticeBillingSubscriptionPrices = {
  ...
  annualDiscount?: Maybe<Money>;
  annualDiscountPrice?: Maybe<Money>;
  annualPrice?: Maybe<Money>;
  monthlyDiscount?: Maybe<Money>;
  monthlyDiscountPrice?: Maybe<Money>;
...
export type PracticeTemplateConnection = {
  ...
  /** A list of nodes. */
  nodes?: Maybe<Array<Maybe<BankAccountFailureEmailTemplate | BankAccountVerificationEmailTemplate | EmailTemplate | EngagementLetterTemplate | IntroMessageTemplate | NewGroupProposalEmailTemplate | NewProposalEmailTemplate | NewSubmissionEmailTemplate | NextStepsMessageTemplate | ProposalAcceptedBrowserTemplate | ProposalAcceptedEmailTemplate | SystemTemplate | TermsTemplate>>>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};
...
export type PracticeTemplateEdge = {
  ...
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node?: Maybe<BankAccountFailureEmailTemplate | BankAccountVerificationEmailTemplate | EmailTemplate | EngagementLetterTemplate | IntroMessageTemplate | NewGroupProposalEmailTemplate | NewProposalEmailTemplate | NewSubmissionEmailTemplate | NextStepsMessageTemplate | ProposalAcceptedBrowserTemplate | ProposalAcceptedEmailTemplate | SystemTemplate | TermsTemplate>;
};
...
export type Proposal = {
  ...
  recipients: Array<Maybe<ProposalRecipient>>;
...
export type ProposalAcceptedEmailTemplate = EmailTemplateInterface & PracticeTemplate & {
...
export type ProposalBillingScheduleInterface = {
  ...
  start: ProposalStartBillingOnAcceptance | ProposalStartBillingOnDate | ProposalStartBillingOnProposalEndDate | ProposalStartBillingOnProposalStartDate;
  subtitle?: Maybe<Scalars['String']['output']>;
...
export type ProposalCustomTemplateCreateFromProposalPayload = {
  ...
  proposalCustomTemplates?: Maybe<ProposalCustomTemplateConnection>;
};
...
export type ProposalCustomTemplateDeletePayload = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  customTemplates?: Maybe<ProposalCustomTemplateConnection>;
};
...
export type ProposalOnceOffBillingSchedule = ProposalBillingScheduleInterface & {
...
export type ProposalOnceOffBillingStrategy = ProposalBillingStrategyInterface & {
...
export type ProposalRecurringBillingSchedule = ProposalBillingScheduleInterface & {
...
export type ProposalRecurringBillingStrategy = ProposalBillingStrategyInterface & {
...
export type ProposalSource = Proposal | ProposalCustomTemplate | ProposalProvidedTemplate | QuickbooksIntegrationRecurringTransaction | XeroIntegrationRepeatingInvoice;
...
export type ProposalStartBillingOnProposalEndDate = ProposalStartBillingInterface & {
  __typename: 'ProposalStartBillingOnProposalEndDate';
  delay: Duration;
  type: ProposalStartBillingType;
};

export type ProposalStartBillingOnProposalStartDate = ProposalStartBillingInterface & {
...
export type Query = {
  ...
  clientWorkflowStrategy?: Maybe<ClientWorkflowStrategy>;
  ...
  /** Find an Engagement by UUID or ID ( UUID or slug ) */
  engagement: Engagement;
  ...
  practiceTemplate?: Maybe<BankAccountFailureEmailTemplate | BankAccountVerificationEmailTemplate | EmailTemplate | EngagementLetterTemplate | IntroMessageTemplate | NewGroupProposalEmailTemplate | NewProposalEmailTemplate | NewSubmissionEmailTemplate | NextStepsMessageTemplate | ProposalAcceptedBrowserTemplate | ProposalAcceptedEmailTemplate | SystemTemplate | TermsTemplate>;
  /** @deprecated Use queries under `templates` instead */
  practiceTemplates?: Maybe<PracticeTemplateConnection>;
  ...
  proposalProvidedTemplates?: Maybe<ProposalProvidedTemplateConnection>;
  /** Proposal terms message */
...
export type SearchResult = AppClientResult | ClientResult | IgnitionAppServiceType | ProposalCustomTemplate | ProposalProvidedTemplate | ProposalResult | QuickbooksIntegrationRecurringTransaction | Service | XeroIntegrationRepeatingInvoice;
...
export type Service = {
  ...
  priceRule: BillingFixedPriceRule | BillingIncludedPriceRule | BillingMinimumPriceRule | BillingRangePriceRule | BillingUnitPriceRule;
  ...
  workflowTemplates?: Maybe<WorkflowTemplateTypeConnection>;
};
...
export type ServiceGroup = {
  ...
  billingMode: ProposalBillingModeEnum;
  billingSchedules: Array<ProposalOnceOffBillingSchedule | ProposalRecurringBillingSchedule>;
  /** @deprecated Use billing_schedules instead */
  billingStrategy: ProposalOnceOffBillingStrategy | ProposalRecurringBillingStrategy;
  ...
  position: Scalars['Int']['output'];
  project: Project;
  proposedServices: Array<Maybe<ProposedService>>;
  subtitle?: Maybe<Scalars['String']['output']>;
...
export type Templates = {
  ...
  introMessageTemplate?: Maybe<IntroMessageTemplate>;
  /** Intro message templates */
  introMessageTemplates?: Maybe<IntroMessageTemplateConnection>;
  ...
  newProposalEmailTemplate?: Maybe<NewProposalEmailTemplate>;
  /** Email templates for advising client of new proposal */
  newProposalEmailTemplates?: Maybe<NewProposalEmailTemplateConnection>;
  ...
  nextStepsMessageTemplate?: Maybe<NextStepsMessageTemplate>;
  nextStepsMessageTemplates?: Maybe<NextStepsMessageTemplateConnection>;
  ...
  termsTemplates?: Maybe<TermsTemplateConnection>;
};
...
export type User = {
  ...
  notifications?: Maybe<NotificationsConnectionType>;
  referenceNumber: Scalars['ID']['output'];
  referralDetails?: Maybe<Array<ReferralDetails>>;
...
export type Xero = {
  ...
  deployInvoices?: Maybe<Scalars['Boolean']['output']>;
  id: Scalars['ID']['output'];
  ...
  state: XeroState;
  syncClientName?: Maybe<Scalars['Boolean']['output']>;
  taxRateMappings?: Maybe<XeroTaxRateMappingConnectionType>;
  taxRates?: Maybe<Array<TaxRate>>;
  trackingCategories?: Maybe<Array<XeroTrackingCategory>>;
};
...
export type XeroBrandingThemeConnection = {
  __typename: 'XeroBrandingThemeConnection';
  /** A list of edges. */
  edges: Array<XeroBrandingThemeEdge>;
  /** A list of nodes. */
  nodes: Array<XeroBrandingTheme>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

/** An edge in a connection. */
export type XeroBrandingThemeEdge = {
  __typename: 'XeroBrandingThemeEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
...
export type Quickbooks = {
  ...
  items?: Maybe<QuickbooksItemConnection>;
  lastSynced?: Maybe<Scalars['DateTime']['output']>;
  ...
  taxCodeMappings?: Maybe<QuickbooksTaxCodeMappingConnectionType>;
  /** @deprecated Use appTaxes query instead. */
  taxCodes?: Maybe<Array<QuickbooksTaxCode>>;
};
...
export type RemoveAcknowledgementMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  level: AcknowledgementLevel;
}>;


export type RemoveAcknowledgementMutation = { __typename: 'Mutation', acknowledgementRemove?: { __typename: 'AcknowledgementRemovePayload', acknowledgements?: Array<{ __typename: 'Acknowledgement', id: string, level: AcknowledgementLevel, updatedAt: any }> } };
...
export type CurrentPracticeQuery = { __typename: 'Query', currentPractice: { __typename: 'Practice', id: string } };
