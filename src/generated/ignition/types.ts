...
export type AgreedService = {
  ...
  client: Client;
  description: Textile;
  discount: BillingAmountDiscountRule | BillingNoneDiscountRule | BillingPercentDiscountRule;
  /**
...
export type EngagedJobRecurrenceUnion = EngagedJobRecurrenceNonRecurring | EngagedJobRecurrenceRecurring;
...
export type EngagedService = {
  ...
  priceRule?: Maybe<BillingFixedPriceRule | BillingIncludedPriceRule | BillingMinimumPriceRule | BillingRangePriceRule | BillingUnitPriceRule>;
...
export type EngagedServiceBillingUnion = EngagedServiceBillingEstimateRange | EngagedServiceBillingEstimateUnit | EngagedServiceBillingIncluded | EngagedServiceBillingOnCompletion | EngagedServiceBillingRecurring | EngagedServiceBillingUpfront;
...
export type SearchResult = AppClientResult | BillingItemResult | ClientResult | IgnitionAppServiceType | ProposalCustomTemplate | ProposalProvidedTemplate | ProposalResult | QuickbooksIntegrationRecurringTransaction | Service | XeroIntegrationRepeatingInvoice;
